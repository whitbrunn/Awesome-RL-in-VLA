...
| 02 | <details><summary>${\pi}^{*}_{0.6}$</summary>: a VLA That Learns From Experience<details> | Nov 2025 | <details><summary>RECAP</summary>- consists of 3 steps: (1)data collection, (2)value function training and (3)advantage conditioned training.</details> | Physical Intelligence (PI) | [Notes](notes/attachments/Pi%2006_260127.pdf) |
